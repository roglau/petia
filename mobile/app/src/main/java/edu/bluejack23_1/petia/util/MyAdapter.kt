...
class MyAdapter(private val petList: ArrayList<Pet>, private val viewModel: WishlistViewModel, private val context: Context, private val someActivityResultLauncher: ActivityResultLauncher<Intent>) : RecyclerView.Adapter<MyAdapter.MyViewHolder>() {
    ...
    private fun fetchWishlist(petID: String ?= null, userID: String ?= null, holder: MyViewHolder) {
        viewModel.getWishlist(petID, userID) { wishlists ->
            if (wishlists.isNotEmpty()) {
